...
val connectionString = ConnectionStringBuilder("Endpoint=sb://v-hdevathraj-hub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=zSjZdwAeZRiaZ3+7l6ZaPsFd6KFT2cZYWIi67ZEfD0g=")
  .setEventHubName("hub")
  .build
