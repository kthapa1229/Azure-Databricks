...
# eventsDF = spark.read.parquet("/mnt/training/ecommerce/events/events.parquet")
# productsDF = spark.read.parquet("/mnt/training/ecommerce/products/products.parquet")
...
salesOutputPath = "/mnt/adf" + "/sales.parquet"
...
usersOutputPath = "/mnt/adf" + "/users.parquet"
...
eveentsOutputPath = "/mnt/adf" + "/events.parquet"

(eventsDF.write
  .option("compression", "snappy")
  .mode("overwrite")
  .parquet(eveentsOutputPath)
)

# COMMAND ----------

productsOutputPath = "/mnt/adf" + "/products.parquet"
...
eventsOutputPath = "/mnt/adf" + "/delta/events"
...
usersOutputPath = "/mnt/adf" + "/delta/users"
...
# TODO
productsOutputPath = "/mnt/adf" + "/delta/products"
