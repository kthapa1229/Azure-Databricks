...
# MAGIC %run ./Includes/storage-path
...
checkpointPath = "/mnt/adf" + "/email_traffic/delta/checkpoint"
outputPath = "/mnt/adf" + "/email_traffic/delta/output"
...
couponSalesDF = (df.withColumn("items", explode("items"))
...
# TODO
couponsCheckpointPath = "/mnt/adf"+"/coupon-sales/checkpoint"
couponsOutputPath = "/mnt/adf"+"/coupon-sales/output"

couponSalesQuery = (couponSalesDF.writeStream
                    .outputMode("append")
                    .format("parquet")
                    .queryName("couponSalesDF")
                    .trigger(processingTime="1 second")
